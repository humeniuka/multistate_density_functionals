...
The development of a multi-configurational DFT is an active research area.
...
The Hohenberg-Kohn (HK) theorem tells us that the ground state density $\rho_0(\vec{r})$
