...
def compare_vW_kinetic_energy_densities(mol, nstate=2):
    ...
    for istate in range(0, min(3,nstate)):
        for jstate in range(istate, min(3,nstate)):
    ...
    #plt.savefig("vW_kinetic_energy_neon.png", dpi=300)
    plt.show()
...
if __name__ == "__main__":
    ...
    compare_vW_kinetic_energy_densities(mol, nstate=2)
