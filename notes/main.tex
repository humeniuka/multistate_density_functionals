...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title[]
  {Local functionals for multistate density functional theory}
...
matrix density $\m{D}(\vec{r})$. \cite[theorem 1]{Lu2022JPCL} This multi-state analogue of the Hohenberg-Kohn theorem implies that the Hamiltonian can be split into an
...
If the state in the subspace are transformed as $\vert \Psi_I' \rangle = \sum_{J=1}^N L^*_{IJ} \vert \Psi_J \rangle$,
...
universal matrix functional can be approximated. Of course the exact functional is unknown, but 
...
An important open question is how to find approximate multistate density functionals. Before embarking on this project,
one has to clarify the definition of the functional that should be approximated. Multistate density functional theory (MSDFT)
...
energy are so huge, while the errors of the off-diagonal elements are perfectly acceptable.
...
The multistate DFT theory by Lu and Gao \cite{Lu2022JPCL} is better positioned in this regard.
