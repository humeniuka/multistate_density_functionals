...
In general variational DFT methods suffer from the lack of a clear route to designing new
functionals that go beyond repurposing existing KS-DFT functionals.

% They justify why the $\Delta$SCF method sometimes works very well.
The multistate DFT theory by Lu and Gao \cite{Lu2022JPCL} might be better positioned in this regard.
...
and the transition densities between them in the off-diagonal elements. It represent the electron density operator
...
suggested in theorem (3) of Ref.~ \ref{Lu2022JPCL} (and explored further in Ref.~\cite{Lu2022fundamental}) has not been implemented yet. So with the current computer program it is
...
Isovalues of 0.025 and 0.005 were for the state densities and the transition densities, respectively.}
