...
The libxc implementation of the Becke's 88 GGA exchange and Chachiyo's LDA correlation
are used.
"""
...
def msdft_hamiltonian(msmd: MultistateMatrixDensityFCI):
    ...
    """
    exchange_correlation = LibxcFunctional(msmd.mol,
        xc_code='GGA_X_B88,LDA_C_CHACHIYO', spin=0, level=4)
