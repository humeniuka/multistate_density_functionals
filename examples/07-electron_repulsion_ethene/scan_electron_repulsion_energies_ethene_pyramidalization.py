...
for a range of the ethylene geometries.
...
if __name__ == "__main__":
    ...
    # data along the scan.
    scan_data = {
        # torsion around carbon-carbon double bond (in °)
        'torsion_angle': [],
        # pyramidalization angle of one CH2 group (in °), the scan variable
    ...
    # The pyramidalization angle is scanned from 60° to 180°.
    ...
    for pyramidalization_angle in pyramidalization_angles:
        ...
        with open('electron_repulsion_energies_ethene_pyramidalization.json', 'w') as filehandle:
