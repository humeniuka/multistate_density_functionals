...
The energy densities are compared for the ground state of the carbon atom and
are plotted on a radial grid.

The exact ground state wavefunction of carbon is obtained by full CI.
"""
...
#plt.savefig("carbon_xc_energy_density_libxc.svg")
#plt.savefig("carbon_xc_energy_density_libxc.png", dpi=300)
