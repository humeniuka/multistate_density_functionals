...
class TestLiebOxfordBound(unittest.TestCase):
    ...
    def create_density_function(self, msmd: MultistateMatrixDensity) -> callable:
        """
    ...
    def check_direct_Coulomb_energy(self, mol):
        ...
        density_function = self.create_density_function(msmd)
    ...
    def check_lower_bound(self, mol):
        ...
        exact_electron_repulsion = msmd.exact_electron_repulsion()
        ...
        self.assertLessEqual(exact_electron_repulsion, lower_bound)
